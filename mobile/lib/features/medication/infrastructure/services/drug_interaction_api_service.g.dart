...
class _DrugInteractionApiService implements DrugInteractionApiService {
  _DrugInteractionApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<InteractionAnalysis> checkUserMedicationInteractions() async {
    ...
    late InteractionAnalysis _value;
    try {
      _value = InteractionAnalysis.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<MedicationEnrichmentResponse> getRxNormDetails(String rxcui) async {
    ...
    final _options = _setStreamType<MedicationEnrichmentResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/drug-interactions/rxnorm/${rxcui}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<RxNormSearchResponse> getInteractionSeverityLevels() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
