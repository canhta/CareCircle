...
mixin _$MedicationQueryParams {
 ...
 bool? get isActive; MedicationForm? get form; String? get classification; DateTime? get startDateFrom; DateTime? get startDateTo; DateTime? get endDateFrom; DateTime? get endDateTo; String? get prescriptionId; int get limit; int get offset; String get sortBy; String get sortOrder;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,isActive,form,classification,startDateFrom,startDateTo,endDateFrom,endDateTo,prescriptionId,limit,offset,sortBy,sortOrder);

@override
String toString() {
  return 'MedicationQueryParams(isActive: $isActive, form: $form, classification: $classification, startDateFrom: $startDateFrom, startDateTo: $startDateTo, endDateFrom: $endDateFrom, endDateTo: $endDateTo, prescriptionId: $prescriptionId, limit: $limit, offset: $offset, sortBy: $sortBy, sortOrder: $sortOrder)';
}
...
@useResult
$Res call({
 bool? isActive, MedicationForm? form, String? classification, DateTime? startDateFrom, DateTime? startDateTo, DateTime? endDateFrom, DateTime? endDateTo, String? prescriptionId, int limit, int offset, String sortBy, String sortOrder
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool? isActive,  MedicationForm? form,  String? classification,  DateTime? startDateFrom,  DateTime? startDateTo,  DateTime? endDateFrom,  DateTime? endDateTo,  String? prescriptionId,  int limit,  int offset,  String sortBy,  String sortOrder)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MedicationQueryParams() when $default != null:
return $default(_that.isActive,_that.form,_that.classification,_that.startDateFrom,_that.startDateTo,_that.endDateFrom,_that.endDateTo,_that.prescriptionId,_that.limit,_that.offset,_that.sortBy,_that.sortOrder);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool? isActive,  MedicationForm? form,  String? classification,  DateTime? startDateFrom,  DateTime? startDateTo,  DateTime? endDateFrom,  DateTime? endDateTo,  String? prescriptionId,  int limit,  int offset,  String sortBy,  String sortOrder)  $default,) {final _that = this;
switch (_that) {
case _MedicationQueryParams():
return $default(_that.isActive,_that.form,_that.classification,_that.startDateFrom,_that.startDateTo,_that.endDateFrom,_that.endDateTo,_that.prescriptionId,_that.limit,_that.offset,_that.sortBy,_that.sortOrder);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool? isActive,  MedicationForm? form,  String? classification,  DateTime? startDateFrom,  DateTime? startDateTo,  DateTime? endDateFrom,  DateTime? endDateTo,  String? prescriptionId,  int limit,  int offset,  String sortBy,  String sortOrder)?  $default,) {final _that = this;
switch (_that) {
case _MedicationQueryParams() when $default != null:
return $default(_that.isActive,_that.form,_that.classification,_that.startDateFrom,_that.startDateTo,_that.endDateFrom,_that.endDateTo,_that.prescriptionId,_that.limit,_that.offset,_that.sortBy,_that.sortOrder);case _:
  return null;
...
class _MedicationQueryParams implements MedicationQueryParams {
  const _MedicationQueryParams({this.isActive, this.form, this.classification, this.startDateFrom, this.startDateTo, this.endDateFrom, this.endDateTo, this.prescriptionId, this.limit = 50, this.offset = 0, this.sortBy = 'name', this.sortOrder = 'asc'});
...
/// Create a copy of MedicationQueryParams
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isActive = freezed,Object? form = freezed,Object? classification = freezed,Object? startDateFrom = freezed,Object? startDateTo = freezed,Object? endDateFrom = freezed,Object? endDateTo = freezed,Object? prescriptionId = freezed,Object? limit = null,Object? offset = null,Object? sortBy = null,Object? sortOrder = null,}) {
