...
_InventoryQueryParams _$InventoryQueryParamsFromJson(
  ...
  expirationDateFrom: json['expirationDateFrom'] == null
      ? null
      : DateTime.parse(json['expirationDateFrom'] as String),
  expirationDateTo: json['expirationDateTo'] == null
      ? null
      : DateTime.parse(json['expirationDateTo'] as String),
  limit: (json['limit'] as num?)?.toInt() ?? 50,
  offset: (json['offset'] as num?)?.toInt() ?? 0,
  sortBy: json['sortBy'] as String? ?? 'lastUpdated',
...
Map<String, dynamic> _$InventoryQueryParamsToJson(
  ...
  'expirationDateFrom': instance.expirationDateFrom?.toIso8601String(),
  'expirationDateTo': instance.expirationDateTo?.toIso8601String(),
