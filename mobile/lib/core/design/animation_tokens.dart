...
class CareCircleAnimationTokens {
  ...
  static Map<String, dynamic> getMedicalAnimation(String vitalType) {
    switch (vitalType.toLowerCase()) {
      case 'heart_rate':
        return {'duration': heartRateInterval, 'curve': heartRateCurve};
      case 'blood_pressure':
        return {
      ...
      case 'temperature':
        return {'duration': temperatureAnimation, 'curve': temperatureCurve};
      case 'medication':
        return {'duration': medicationIntake, 'curve': medicationCurve};
      default:
        return {'duration': standard, 'curve': standardEase};
    }
  }
  ...
  static Duration getStaggerDelay(
    int index, {
    Duration baseDelay = microStagger,
  }) {
  ...
  static Map<String, dynamic> getChartAnimation(String chartType) {
    switch (chartType.toLowerCase()) {
      ...
      case 'pie':
        return {'duration': slow, 'curve': gentleEase};
      default:
        return {'duration': chartAnimation, 'curve': medicalDataCurve};
    }
  }
}
