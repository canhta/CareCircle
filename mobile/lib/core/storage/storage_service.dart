...
class StorageService {
  ...
  static Future<void> setCacheJson(String boxName, String key, Map<String, dynamic> value) async {
    await HiveStorageService.putJson(boxName, key, value);
  }

  /// Retrieve JSON data from cache
  static Future<Map<String, dynamic>?> getCacheJson(String boxName, String key) async {
  ...
  static Future<void> cacheHealthMetrics(List<Map<String, dynamic>> metrics) async {
  ...
  static Future<List<Map<String, dynamic>>?> getCachedHealthMetrics() async {
    final data = await getCacheJson(HiveBoxNames.healthMetrics, 'latest_metrics');
  ...
  static Future<Map<String, dynamic>> getStorageHealth() async {
    try {
      ...
      final healthMetricsSize = await HiveStorageService.getBoxSize(HiveBoxNames.healthMetrics);
      final conversationsSize = await HiveStorageService.getBoxSize(HiveBoxNames.conversations);
