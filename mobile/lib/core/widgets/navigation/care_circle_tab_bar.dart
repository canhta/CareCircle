...
class CareCircleTabBar extends StatelessWidget {
    ...
    return Semantics(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: backgroundColor ?? CareCircleColorTokens.lightColorScheme.surface,
          boxShadow: [
            BoxShadow(
  ...
  Widget _buildTabIcon(BuildContext context, CareCircleTab tab, bool isSelected, bool isEnabled) {
    ...
    return Stack(
      ...
      children: [
        ...
        if (tab.urgencyIndicator != null && tab.urgencyIndicator != UrgencyLevel.none)
  ...
  Widget _buildTabLabel(BuildContext context, CareCircleTab tab, bool isSelected, bool isEnabled) {
  ...
  Color _getIconColor(BuildContext context, bool isSelected, bool isEnabled) {
    ...
    return unselectedItemColor ?? CareCircleColorTokens.lightColorScheme.onSurfaceVariant;
  }
